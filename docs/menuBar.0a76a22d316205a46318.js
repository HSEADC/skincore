...
;// CONCATENATED MODULE: ./src/data-search.js

var token = 'patdoxuhCUQ3CbGAf.507bb1b800d0d8f4427f87bfd694ca314f086ef093010c6e3e7e3262ff862fb5';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('app4QpCmatGzmtnxW');
...
;// CONCATENATED MODULE: ./src/components/S_Header/S_Header.jsx
function S_Header_typeof(obj) { "@babel/helpers - typeof"; return S_Header_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, S_Header_typeof(obj); }

function S_Header_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function S_Header_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function S_Header_createClass(Constructor, protoProps, staticProps) { if (protoProps) S_Header_defineProperties(Constructor.prototype, protoProps); if (staticProps) S_Header_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }

function S_Header_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) S_Header_setPrototypeOf(subClass, superClass); }

function S_Header_setPrototypeOf(o, p) { S_Header_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return S_Header_setPrototypeOf(o, p); }

function S_Header_createSuper(Derived) { var hasNativeReflectConstruct = S_Header_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = S_Header_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = S_Header_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return S_Header_possibleConstructorReturn(this, result); }; }

function S_Header_possibleConstructorReturn(self, call) { if (call && (S_Header_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return S_Header_assertThisInitialized(self); }

function S_Header_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function S_Header_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function S_Header_getPrototypeOf(o) { S_Header_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return S_Header_getPrototypeOf(o); }

function S_Header_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var S_Header = /*#__PURE__*/function (_React$Component) {
  S_Header_inherits(S_Header, _React$Component);

  var _super = S_Header_createSuper(S_Header);

  function S_Header(props) {
    var _this;

    S_Header_classCallCheck(this, S_Header);

    _this = _super.call(this, props);

    S_Header_defineProperty(S_Header_assertThisInitialized(_this), "getPathFromUrl", function (url) {
      return url.split(addressPart)[0];
    });

    S_Header_defineProperty(S_Header_assertThisInitialized(_this), "handleSearchInput", function (searchInputValue) {
    ...
    S_Header_defineProperty(S_Header_assertThisInitialized(_this), "handleSearchSubmit", function () {
...
var homeURL = 'https://hseadc.github.io/skincore/';
var menu = [{
  text: 'Словарь',
  url: 'dictionary.html'
}, {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  root.render( /*#__PURE__*/react.createElement(S_Header, _extends({
