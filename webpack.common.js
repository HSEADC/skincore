...
const paths = [
  ...
  '/checklist.html/',
  '/search.html/',
  '/article/acneprevention.html/',
  '/article/airpollution.html/',
  '/article/devices.html/',
  '/article/fastcare.html/',
  '/article/formula.html/',
  '/article/haleybieber.html/',
  '/article/homemaderecipes.html/',
  '/article/hydration.html/',
  '/article/skinaging.html/',
  '/article/spf.html/',
  '/article/undereye.html/',
  '/article/winterskincare.html/',
  '/checklist/agingskin.html/',
  '/checklist/basicset.html/',
  '/checklist/dryskin.html/',
  '/checklist/fortrip.html/',
  '/checklist/korean.html/',
  '/checklist/oilyskin.html/',
  '/checklist/oliviarodrigo.html/',
  '/checklist/sensitiveskin.html/',
  '/checklist/teenskincare.html/',
  '/checklist/wintercare.html/',
  '/dictionary/aloevera.html/',
  '/dictionary/collagen.html/',
  '/dictionary/conservants.html/',
  '/dictionary/cream.html/',
  '/dictionary/foam.html/',
  '/dictionary/gel.html/',
  '/dictionary/glycerin.html/',
  '/dictionary/hialuronicacid.html/',
  '/dictionary/hydrophilic.html/',
  '/dictionary/lacticacid.html/',
  '/dictionary/mask.html/',
  '/dictionary/niacinamide.html/',
  '/dictionary/patch.html/',
  '/dictionary/peeling.html/',
  '/dictionary/peptides.html/',
  '/dictionary/powder.html/',
  '/dictionary/propyleneglycol.html/',
  '/dictionary/retinol.html/',
  '/dictionary/salicyllicacid.html/',
  '/dictionary/scrub.html/',
  '/dictionary/serum.html/',
  '/dictionary/spf.html/',
  '/dictionary/toner.html/',
  '/dictionary/vitaminc.html/',
  '/dictionary/vitaminc.html/',
  '/tests/dryskin.html/',
  '/tests/knowledge.html/',
  '/tests/serum.html/',
  '/tests/typeofskin.html/',
];
